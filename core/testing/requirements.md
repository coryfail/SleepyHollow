...
explicit full-suite escalation. SH-F003 supplies typed validation and Problem
Details behavior, SH-F004 supplies isolated Deno KV contexts, and SH-F006
supplies approved parsed requirements and dependency metadata.
